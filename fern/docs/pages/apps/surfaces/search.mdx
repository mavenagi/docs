...
The search app supports several basic configuration options that can be customized through the Dashboard:

- **Logo** - The image displayed on the search page.
...
- **Popular Questions** - Pre-defined questions shown to help users get started with their search.
