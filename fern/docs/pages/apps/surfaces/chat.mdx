...
| `iFrameHorizontalOffset` | integer | No | 0 | Horizontal offset in pixels for the iframe position |
| `iFrameVerticalOffset` | integer | No | 0 | Vertical offset in pixels for the iframe position |
| `buttonHorizontalOffset` | integer | No | 0 | Horizontal offset in pixels for the button position |
| `buttonVerticalOffset` | integer | No | 0 | Vertical offset in pixels for the button position |
