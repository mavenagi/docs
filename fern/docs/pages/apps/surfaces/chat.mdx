...
| `iFrameHorizontalOffset` | string | No | 0 | Horizontal offset in pixels for the iframe position |
| `iFrameVerticalOffset` | string | No | 0 | Vertical offset in pixels for the iframe position |
| `buttonHorizontalOffset` | string | No | 0 | Horizontal offset in pixels for the button position |
| `buttonVerticalOffset` | string | No | 0 | Vertical offset in pixels for the button position |
