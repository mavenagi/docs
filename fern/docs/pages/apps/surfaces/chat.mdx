...
Maven Chat has methods to programmatically control the widget.

| Name | Parameters | Output | Description |
|--------|------|----------|---------|-------------|
| `isOpen` | None | boolean | Returns a true if the chat widget is open |
| `open` | None | void | Opens the chat widget |
| `close` | None | void | Closes the chat widget |
| `show` | None | void | Displays the default open button |
| `hide` | None | void | Hides the default open button |
