...
The most common type of event trigger is used to update another system with data from Maven. For example, you could add a tag to every Zendesk ticket where the copilot response was inserted. 

To set this up a Maven App would create an event trigger of type `Feedback Created`. This trigger would be visible within the Agent Designer. 
