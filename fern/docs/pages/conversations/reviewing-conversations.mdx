...
4. **View Details of Knowledge Used**: Click on "View Details" on Maven's suggested reply to see the knowledge documents Maven used in crafting the response. Click on the titles to review the content of those knowledge documents. Reviewing knowledge sources on individual conversations allows you to identify knowledge gaps or additions to consider adding in order to improve Maven’s responses.

5. **Summary Information**: Review the summary on the right-hand side for details like conversation status, agents involved, quality, sentiment, tags, language, date, response time, handle time, and more.
