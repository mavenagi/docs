...
The user will receive an email to join the organization. The user must accept the invite and use the SSO button to log in to activate their account.
...
3. A new tab will open. Click through the flow to configure the connection, test SSO, and complete set up. Domain verification is required.
