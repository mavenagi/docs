...
For more extensive applications that aren't suitable for a serverless environment, you can still use Maven's platform APIs from your own servers. These applications will use standard authentication headers and an API secret obtained from the [Devloper Portal](developers.mavenagi.com).
