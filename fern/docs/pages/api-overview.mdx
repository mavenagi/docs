---
title: Maven AGI Apps and API: Simplifying Integration for Everyone
layout: overview
---
...
- **Custom Event Triggers (Webhooks)**: Set up automated responses to certain events.
...
For more extensive applications that aren't suitable for a serverless environment, you can still use Maven's platform APIs from your own servers. These applications will use standard authentication headers and an API secret obtained from developers.mavenagi.com.
